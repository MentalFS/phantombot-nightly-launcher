...
#	cp -pr nightly-download/games-challengeSystem.de.js scripts/lang/german/custom/games/games-challengeSystem.js
	...
	(echo '# This file is automatically generated from ignorebots.local and ignorebots.orig' ; \
		cat addons/ignorebots.local addons/ignorebots.orig | sort -u) > addons/ignorebots.txt
